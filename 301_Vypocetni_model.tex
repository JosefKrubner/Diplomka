\section{CFD model}
    ...
    \subsection{Okrajové podmínky}
        \subsubsection{Hranice výpočetní oblasti}
	     ...
	     \begin{figure}[ht!]
					...
					\begin{subfigure}{0.3\textwidth}
                             ...
                             \label{fig:outlet}
                         \end{subfigure}
                    \caption{Části hranice pro aplikování okrajových podmínek.}
        ...
        \subsubsection{Stěny}
            Při numerických simulacích bylo pro vyhodnocení restitučních faktorů počítat s přestupem tepla do pevných látek a s jeho šířením objemem. V místech kontaktu proudícího média s stěnami geometrie byla proto použita podmínka sdílené teploty – teplota na hranici tekutiny byla přenesena na hranici tělesa.
