\section{CFD model}
    ...
    \subsection{Numerický řešič}
        ...
        \subsubsection{Numerické schéma}
            ...
            Výhoda sdruženého algoritmu spočívá u stacionárních úloh zejména v rychlosti konvergence \cite{Ansys2020User} – při testování vhodného schématu pro výpočty prezentované v této práci bylo s využitím sdruženého schématu dosaženo konvergence po přibližně \linebreak $10\times$ méně iteracích, než tomu bylo u schématu SIMPLE.
