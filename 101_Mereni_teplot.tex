\section{Měření teplot při vysokých podzvukových rychlostech} \label{sec:mereni-teplot}
    ...
    \subsection{Měření stagnační teploty}
        ...
        \subsubsection{Měřicí sondy}
            Konstrukce sond pro měření stagnačních teplot typicky obsahuje tepelně citlivý prvek (obvykle termočlánek nebo odporový teplotní snímač) umístěný v trubici s odvětráním, která slouží ke zpomalení proudění okolo čidla obvykle pod hodnotu \linebreak $\Ma = 0.15$ \cite{Bonham2013}. Snížením rychlosti plynu dojde k nárůstu jeho měrné entalpie, což se projeví i vyšší naměřenou teplotou, která se tak bude blížit stagnační teplotě volného proudu.
            
            Příklady konstrukcí používaných pro měření stagnačních teplot jsou uvedeny na Obrázku \ref{fig:konstrukce-mereni-T0}
